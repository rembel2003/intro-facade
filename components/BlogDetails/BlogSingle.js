                        ...
                        <div className="wpo-blog-content">
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    ...
                                    <ul>
                                        ...
                                        <li><Link href="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack">Architecture</Link></li>
                                        <li><Link href="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack">creative</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack" target="_blank"><Image src={blog6} alt="" /></Link>
                                </div>
